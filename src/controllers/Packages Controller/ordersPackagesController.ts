...
import {  createNewOrderPackage, deleteOrderPackage, updateOrderPackage , getOrderPackage} from '../../services/Packages Services/ordersPackagesServices';
...
//----------------------- get a specific package order-----------------------
export const c_getOrderPackage = async (req:Request , res:Response) =>{
    const result = await getOrderPackage(req, res);
    res.status(200).json(result);
}
