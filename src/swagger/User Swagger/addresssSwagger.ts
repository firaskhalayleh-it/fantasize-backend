 ...
 *               AddressId:
 *                 type: integer
 *                 description: If you want update your address ... enter the address ID
 *               AddressLine:
 *                 type: string
...
/**
 * @swagger
 * /api/user/delete_address_user/{addressId}:
 *   delete:
 *     tags:
 *       - Addresses
